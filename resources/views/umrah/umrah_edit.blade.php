                                                    ...
                                                    <tbody>
                                                        <tr class="p-3" style="vertical-align: top;"
                                                            ...
                                                            <td>
                                                                <input type="number" name="Fare[]"
                                                                    id="Fare_{{ $no }}" class=" form-control row-calculation"
                                                                    autocomplete="off" step="0.01" placeholder="Fare"
                                                            ...
                                                            <td>
                                                                <input readonly type="number" name="ItemTotal[]"
                                                                    id="Total_{{ $no }}" class=" form-control "
                                                                    autocomplete="off" step="0.01" placeholder="Total"
                                                                    value="{{ $value1->Total }}">
                                                            ...
                                                            <td>
                                                                <input type="number" name="Paid[]"
                                                                    id="Paid_{{ $no }}"
                                                                    class=" form-control totalLinePrice row-calculation"
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            ...
                                                            <td> 
                                                               ...
                                                               <input type="number" name="TaxPer[]" id="TaxPer_{{ $no }}"
