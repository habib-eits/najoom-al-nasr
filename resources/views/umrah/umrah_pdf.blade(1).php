  ...
  <tr>
    <td colspan="8"><table width="50%" border="0" align="right" >
      ...
      <tr>
        ...
        <td height="20"><strong>{{ env('APP_CURRENCY') }}{{number_format($invoice_mst[0]->Total,2)}}</strong></td>
      </tr>
      
      
      <tr>
        <td height="20" align="right" style="padding-right: 25px;"><strong>Bank Charges</strong></td>
        <td height="20"><strong>{{ env('APP_CURRENCY') }}{{number_format($invoice_mst[0]->BankCharges,2)}}</strong></td>
      </tr>
      
      
      <tr>
        <td height="20" align="right" style="padding-right: 25px;"><strong>Grand Total</strong></td>
        <td height="20"><strong>{{ env('APP_CURRENCY') }}{{number_format($invoice_mst[0]->GrandTotal ?? $invoice_mst[0]->Total,2)}}</strong></td>
      </tr>
      <tr>
