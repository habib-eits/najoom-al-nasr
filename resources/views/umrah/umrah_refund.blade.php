                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-1 row">
                                                        <div class="col-sm-3">
                                                            <label class="col-form-label" for="first-name">Invoice
                                                                #</label>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <input type="text" id="first-name" class="form-control"
                                                                name="VHNO" value="{{ $vhno[0]->VHNO }}"
                                                                readonly="">
                                                ...
                                                <table width="100%">
                                                    <thead>
                                                        ...
                                                        @foreach ($invoice_det as $key => $value1)
                                                            ...
                                                            <tr class="bg-light borde-1 border-light "
                                                                style="height: 40px;" id="t_{{ $no }}">
                                                    ...
                                                    <tbody>
                                                        <tr class="p-3" style="vertical-align: top;"
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="ItemID[]" id="ItemID_{{ $no }}"
                                                            ...
                                                            <td>
                                                                <select name="PickPoint[]"
                                                                    id="PickPoint_{{ $no }}"
                                                                    class="form-select">
                                                                    <option value="Sharja"
                                                                        {{ 'Sharja' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                                        Sharja</option>
                                                                    <option value="Dubai"
                                                                        {{ 'Dubai' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                                        Dubai</option>
                                                                    <option value="Abu Dahbi"
                                                                        {{ 'Abu Dahbi' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                                        Abu Dahbi</option>
                                                                    <option value="Jebel Ali"
                                                                        {{ 'Jebel Ali' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                                        Jebel Ali</option>
                                                                    <option value="Al Ain"
                                                                        {{ 'Al Ain' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                                        Al Ain</option>
                                                                    <option value="Ras Al-Khaimah"
                                                                        {{ 'Ras Al-Khaimah' == $value1->PickPoint ? 'selected=selected' : '' }}>
                                                            ...
                                                            <td>
                                                                <select name="VisaType[]"
                                                                    ...
                                                                    class="form-select">
                                                                    <option value="Multi"
                                                                        {{ 'Multi' == $value1->VisaType ? 'selected=selected' : '' }}>
                                                                        Multi</option>
                                                                    <option value="Umrah"
                                                                        {{ 'Umrah' == $value1->VisaType ? 'selected=selected' : '' }}>
                                                                        Umrah</option>
                                                                </select>
                                                            ...
                                                            <td>
                                                                <input type="number" name="Paid[]"
                                                                    ...
                                                                    class=" form-control row-calculation totalLinePrice"
                                                                    autocomplete="off" step="0.01" placeholder="Paid"
                                                                    value="{{ $value1->Paid }}">
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            style="height: 40px; font-weight: bolder;"
                                                            id="ttt_{{ $no }}">
                                                            <td></td>
                                                            <td>Supplier</td>
                                                            <td><span>Pax Contact</span><span
                                                                    style="float: right; padding-right: 55px;">Pax
                                                                    Passport</span> </td>
                                                            <td>Room Type</td>
                                                            <td>VAT</td>
                                                            <td>Net Profit</td>
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="Contact_{{ $no }}" name="Contact[]"
                                                                        placeholder="Contact"
                                                                        value="{{ $value1->Contact }}">
                                                            ...
                                                            <td> <select name="RoomType[]"
                                                                    ...
                                                                    class="form-select">
                                                                    <option value="Quad"
                                                                        {{ 'Quad' == $value1->RoomType ? 'selected=selected' : '' }}>
                                                                        Quad </option>
                                                                    <option value="Triple"
                                                                        {{ 'Triple' == $value1->RoomType ? 'selected=selected' : '' }}>
                                                                        Triple</option>
                                                                    <option value="Double"
                                                                        {{ 'Double' == $value1->RoomType ? 'selected=selected' : '' }}>
                                                                        Double</option>
                                                                    <option value="Sharing"
                                                                        {{ 'Sharing' == $value1->RoomType ? 'selected=selected' : '' }}>
                                                                        Sharing</option>
                                                                </select>
                                                            </td>
                                                            <td> <input type="number" name="TaxPer[]"
                                                                    id="TaxPer_{{ $no }}"
                                                                ...
                                                                <input type="number" name="Taxable[]"
                                                                    id="Taxable_{{ $no }}"
                                                                    class=" form-control vat" autocomplete="off"
                                                                    step="0.01" placeholder="Taxable" readonly=""
                                                                    value="{{ $value1->Taxable }}">
                                                            </td>
                                                            <td> <input type="number" name="Service[]"
                                                                    id="Service_{{ $no }}"
                                                                    class=" form-control service row-calculation" autocomplete="off"
                                                                    step="0.01" placeholder="Service"
                                                                    value="{{ $value1->Service }}">
                                                            </td>
                                                            <td> <input readonly type="number" name="PaymentInBus[]"
                                                                    id="PaymentInBus_{{ $no }}"
                                                                    class=" form-control" autocomplete="off"
                                                                    step="0.01" placeholder="Payment in bus"
                                                                    value="{{ $value1->PaymentInBus }}">
                                                            </td>
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            style="height: 40px; font-weight: bolder;" id="file_1">
                                                            <td></td>
                                                            <td>


                                                                <div class="mt-2 mb-3">
                                                                    <label for="PassportFile_1" class="fw-bolder">Passport
                                                                    </label> <i
                                                                        class="mdi mdi-trash-can-outline text-danger"
                                                                        style="font-size: 16pt;float:right;margin-top:-7px;"
                                                                        onclick="removepicture('PassportFile_Old_',{{ $no }});"></i>

                                                                    <input type="file" class="form-control"
                                                                        name="PassportFile[]" id="PassportFile_1">
                                                                    <input type="hidden" class="form-control"
                                                                        name="PassportFile_Old[]"
                                                                        id="PassportFile_Old_{{ $no }}"
                                                                        value="{{ $value1->PassportFile }}">
                                                                    ...
                                                                    @if ($value1->PassportFile)
                                                                        ...
                                                                        @if ($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png')
                                                                            ...
                                                                            <img src="{{ asset('/') . $value1->PassportFile }}"
                                                                                class="rounded avatar-sm" width="50px"
                                                                                height="50px"
                                                                                onclick="openImageModal('{{ asset('/') . $value1->PassportFile }}')"
                                                                                id="placeholder_PassportFile_Old_{{ $no }}">
                                                                        @elseif($extension === 'pdf')
                                                                            <!-- Display the PDF icon with a link to open the PDF in a new tab -->
                                                                            <a href="{{ asset('/') . $value1->PassportFile }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('/pdf_icon.jpg') }}"
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="mt-2 mb-3">
                                                                    ...
                                                                    <label for="PassportFile_1" class="fw-bolder">Emirate
                                                                        ID Front</label>
                                                                    <i class="mdi mdi-trash-can-outline text-danger"
                                                                        style="font-size: 16pt;float:right;margin-top:-7px;"
                                                                        onclick="removepicture('EmirateIDFileFront_Old_',{{ $no }});"></i>
                                                                    <input type="file" class="form-control"
                                                                        name="EmirateIDFileFront[]"
                                                                        id="EmirateIDFileFront_1">
                                                                    <input type="hidden" class="form-control"
                                                                        name="EmirateIDFileFront_Old[]"
                                                                        value="{{ $value1->EmirateIDFileFront }}"
                                                                        id="EmirateIDFileFront_Old_{{ $no }}">
    ...
    @endif
     -->
                                                                    ...
                                                                    @if ($value1->EmirateIDFileFront)
                                                                        ...
                                                                        @if ($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png')
                                                                            <!-- Display the image file (jpg, png) -->
                                                                            <img src="{{ asset('/') . $value1->EmirateIDFileFront }}"
                                                                                class="rounded avatar-sm" width="50px"
                                                                                height="50px"
                                                                                onclick="openImageModal('{{ asset('/') . $value1->EmirateIDFileFront }}')"
                                                                                id="placeholder_EmirateIDFileFront_Old_{{ $no }}">
                                                                        @elseif($extension === 'pdf')
                                                                            <!-- Display the PDF icon with a link to open the PDF in a new tab -->
                                                                            <a href="{{ asset('/') . $value1->EmirateIDFileFront }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('/pdf_icon.jpg') }}"
                                                                                    class="rounded avatar-sm"
                                                                                    id="placeholder_EmirateIDFileFront_Old_{{ $no }}">
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="mt-2 mb-3">
                                                                    ...
                                                                    <i class="mdi mdi-trash-can-outline text-danger"
                                                                        style="font-size: 16pt;float:right;margin-top:-7px;"
                                                                        onclick="removepicture('EmirateIDFileBack_Old_',{{ $no }});"></i>
                                                                    <input type="file" class="form-control"
                                                                        name="EmirateIDFileBack[]"
                                                                        id="EmirateIDFileBack_1">
                                                                    <input type="hidden" class="form-control"
                                                                        name="EmirateIDFileBack_Old[]"
                                                                        value="{{ $value1->EmirateIDFileBack }}"
                                                                        id="EmirateIDFileBack_Old_{{ $no }}">
...
@else
    ...
    @endif -->
                                                                    ...
                                                                    @if ($value1->EmirateIDFileBack)
                                                                        ...
                                                                        @if ($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png')
                                                                            <!-- Display the image file (jpg, png) -->
                                                                            <img src="{{ asset('/') . $value1->EmirateIDFileBack }}"
                                                                                class="rounded avatar-sm" width="50px"
                                                                                height="50px"
                                                                                onclick="openImageModal('{{ asset('/') . $value1->EmirateIDFileBack }}')"
                                                                                id="placeholder_EmirateIDFileBack_Old_{{ $no }}">
                                                                        @elseif($extension === 'pdf')
                                                                            <!-- Display the PDF icon with a link to open the PDF in a new tab -->
                                                                            <a href="{{ asset('/') . $value1->EmirateIDFileBack }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('/pdf_icon.jpg') }}"
                                                                                    class="rounded avatar-sm"
                                                                                    id="placeholder_EmirateIDFileBack_Old_{{ $no }}">
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <div class="mt-2 mb-3">
                                                                    <label for="PassportFile_1"
                                                                        class="fw-bolder">Picture</label>
                                                                    <i class="mdi mdi-trash-can-outline text-danger"
                                                                        style="font-size: 16pt;float:right;margin-top:-7px;"
                                                                        onclick="removepicture('PictureFile_Old_',{{ $no }});"></i>

                                                                    <input type="file" class="form-control"
                                                                        name="PictureFile[]" id="PictureFile_1">
                                                                    <input type="hidden" class="form-control"
                                                                        name="PictureFile_Old[]"
                                                                        value="{{ $value1->PictureFile }}"
                                                                        id="PictureFile_Old_{{ $no }}">
...
@else
    ...
    @endif -->
                                                                    ...
                                                                    @if ($value1->PictureFile)
                                                                        ...
                                                                        @if ($extension === 'jpg' || $extension === 'jpeg' || $extension === 'png')
                                                                            <!-- Display the image file (jpg, png) -->
                                                                            <img src="{{ asset('/') . $value1->PictureFile }}"
                                                                                class="rounded avatar-sm" width="50px"
                                                                                height="50px"
                                                                                onclick="openImageModal('{{ asset('/') . $value1->PictureFile }}')"
                                                                                id="placeholder_PictureFile_Old_{{ $no }}">
                                                                        @elseif($extension === 'pdf')
                                                                            <!-- Display the PDF icon with a link to open the PDF in a new tab -->
                                                                            <a href="{{ asset('/') . $value1->PictureFile }}"
                                                                                target="_blank">
                                                                                <img src="{{ asset('/pdf_icon.jpg') }}"
                                                                                    class="rounded avatar-sm"
                                                                                    id="placeholder_PictureFile_Old_{{ $no }}">
                                                            ...
                                                            <td style="vertical-align: top;">
                                                                <label for="" class="fw-bolder mt-2">Deduction
                                                                    Charges</label>
                                                                <input type="number" name="deduction[]"
                                                                    id="deduction_{{ $no }}"
                                                                    class="form-control row-calculation"
                                                                    onblur="this.readonly=true;">
                                                                <label for="PassportFile_1"
                                                                    class="fw-bolder">Nationality</label>
                                                                <select name="Nationality[]" id="Nationality_${i}"
                                                                    class="form-select select2">
                                                                    <option value="">choose</option>
                                                                    @foreach ($nationality as $row)
                                                                        <option value="{{ $row->country_enNationality }}"
                                                                            {{ $row->country_enNationality == $value1->Nationality ? 'selected=selected' : '' }}>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-12  ">
                                                ...
                                                <textarea class="form-control" rows='5' name="remarks" id="notes" placeholder="Your Notes">{{ $invoice_mst[0]->Note }}</textarea>
                        ...
                        if($invoice_mst[0]->Document)
                        {
                          ...
                          ?>
                                                    ...
                                                    <a href="{{ asset('/') . $invoice_mst[0]->Document }}" target="_blank"
                                                        class="btn btn-light">Downlaod File</a>
                                            ...
                                            <div class="col-lg-4 col-12 ">
                                                <form class="form-inline">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span
                                                                class="input-group-text bg-light">{{ env('APP_CURRENCY') }}</span>
                                                            <input type="number" name="Total" class="form-control"
                                                                step="0.01" id="totalAftertax" placeholder="Total"
                                                                onkeypress="return IsNumeric(event);"
                                                                ondrop="return false;" onpaste="return false;"
                                                                value="{{ $invoice_mst[0]->Total }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group mt-1 d-none">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" class="form-control amountDue"
                                                                ...
                                                                onkeypress="return IsNumeric(event);"
                                                                ondrop="return false;" onpaste="return false;"
                                                                step="0.01" value="{{ $invoice_mst[0]->Balance }}">
                                                        </div>
                                                    </div>
    ...
    <script>
       ...
       <thead>
        ...
        $(document).on('change', '.row-calculation', function() {
            ...
            newPaid = parseFloat(Paid) - parseFloat(deduction);

            $('#Paid_' + id[1]).val(newPaid);
