...
@section('content')
                                    ...
                                    <div class="row">
                                                    ...
                                                    <tbody>
                                                        <tr class="p-3" style="vertical-align: top;" id="tt_1">
                                                            <td class="p-1 bg-light borde-1 border-light"><input
                                                                    class="case" type="checkbox" id="1" /></td>
                                                            <td>

                                                                <select name="ItemID[]" id="ItemID_1"
                                                                    class="form-select form-control-sm item-select select2">
                                                            ...
                                                            <td>
                                                                <select name="PickPoint[]" id="PickPoint_1"
                                                                    class="form-select">
                                                            ...
                                                            <td>
                                                                <select name="VisaType[]" id="VisaType_1"
                                                                    class="form-select">
                                                            ...
                                                            <td>
                                                                <input type="number" name="Fare[]" id="Fare_1"
                                                                    ...
                                                                    step="0.01" placeholder="Fare" value="0">


                                                            <td>
                                                                <input type="number" name="ItemTotal[]" id="Total_1"
                                                                    class=" form-control " autocomplete="off"
                                                                    step="0.01" placeholder="Total" value="0" readonly>
                                                            ...
                                                            <td>
                                                                <input type="number" name="Paid[]" id="Paid_1"
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            style="height: 40px; font-weight: bolder;" id="ttt_1">
                                                            <td></td>
                                                            <td>Supplier</td>
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            style="height: 40px; font-weight: bolder;" id="tttt_1">
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="Passport_1" name="Passport[]"
                                                                        placeholder="Passport">

                                                                </div>
                                                            </td>
                                                            <td> <select name="RoomType[]" id="RoomType_1"
                                                                    class="form-select">
                                                            ...
                                                            <td> <input type="number" name="Service[]" id="Service_1"
                                                                    class=" form-control service row-calculation" autocomplete="off"
                                                                    step="0.01" placeholder="Service"
                                                                    value="0"></td>
                                                            <td> <input type="number" name="PaymentInBus[]"
                                                                    id="PaymentInBus_1" class=" form-control"
                                                                    autocomplete="off" step="0.01" readonly
                                                                    placeholder="Payment in bus" value="0"></td>
                                                        ...
                                                        <tr class="bg-light borde-1 border-light "
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="mt-2 mb-3">
                                                                    <label for="PassportFile_1"
                                                                        class="fw-bolder">Passport</label>
                                                            ...
                                                            <td>
                                                                <div class="mt-2 mb-3">
                                                                    ...
                                                                    <select name="Nationality[]" id="Nationality_1"
                                                                        class="form-select select2">
                                                                        <option value="">choose</option>
                                                                        @foreach ($nationality as $row)
                                                                            <option
                                                                                value="{{ $row->country_enNationality }}">
                                                            ...
                                                            <td style="vertical-align: top;" class="d-none">
                                                                <label for="" class="fw-bolder mt-2">Deduction
                                                                    Charges</label>
                                                                <input type="number" name="deduction[]" id="deduction_1"
                                                                    class="form-control"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-12  ">
                                                ...
                                                <textarea class="form-control" rows='2' name="remarks" id="notes" placeholder="Your Notes"></textarea>
    ...
    <script>
      //on load tirgger change event to set initial tax values
      $(document).ready(function () {
        $('.select2').select2(); // Initialize Select2 if not already initialized
        $('.item-select').trigger('change'); // Trigger change event on page load to set initial tax values
      });
    </script>
